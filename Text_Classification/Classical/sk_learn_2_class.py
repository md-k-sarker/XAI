...
def convert_training_documents_to_vector(classes):
...
classes, documents = create_document_and_classes_from_data(x_text, y, y_label)
...
# training data
training, output = convert_training_documents_to_vector(classes)
